    ...
    do
        ...
        if quest_ctx:init(obj) then
            xxmsg(string.format('[%16X] ID[%08X] TYPE[%u] DAILYNUM[%u] STATUS[%u] COMBATPOWER[%u]  TRATYPE[%u] TAR[%u-%u] POS[%0.1f-%0.1f-%0.1f] ISOVER[%-6s]  ISFINISH[%-6s]  MAP[%08X-%-20s] NAME[%s] [%08X]',
                    ...
                    quest_ctx:daily_num(),
                    quest_ctx:status(),
                    quest_ctx:combat_power(),
                    quest_ctx:tar_type(),
                    quest_ctx:tar_num(),
                    quest_ctx:tar_max_num(),
                    quest_ctx:tx(),
                    quest_ctx:ty(),
                    quest_ctx:tz(),
                    quest_ctx:is_over(),
                    ...
                    quest_ctx:map_name(),
                    quest_ctx:name(),
                    quest_ctx:entrust_gather_resid()
            ))
        end
...
function example.test_relation_unit()
    ...
    --23EC3432140   0000C3B4 - 0000C3B5   001  false    06052F02 - 银杏谷         -3790.0 - 18444.0 - 2768.0   半兽人角笛                  血光半兽人角   想按京一说的收集一下半兽人之角，却不知该从何开始。\r\n\r\n京一看上去似乎与<span color="#5B93B4FF">银杏村的警卫队长坛灵</>关系不错，要不去问问他？
    --23EC3432260   0000C3B4 - 0000C3B6   002  false    06052F02 - 银杏谷         -590.0 - 15382.0 - 2814.0   半兽人角笛                  血光半兽人角   京一这家伙！\n到底在人前人后把我说成什么样了？哎！咳……\n\r\n总之，想要知道半兽人宝物是什么的话，看来得找<span color="#5B93B4FF">银杏谷</>的人们聊一聊才行。
    --23EC3432380   0000C3B4 - 0000C3B7   003  false    06052F02 - 银杏谷         22116.2 - -30297.8 - 2359.2   半兽人角笛                  血光半兽人角   特殊的半兽人……\n看来要去找一下<span color="#5B93B4FF">画师万镐</>才行了。据说是在\n千年古树附近？\n快去看看吧。
    --23EC34324A0   0000C3B4 - 0000C3B8   004  false    06052F02 - 银杏谷         22218.0 - -30516.0 - 2209.9   半兽人角笛                  血光半兽人角   如果按照画师万镐所说，那这后面的<span color="#5B93B4FF">瀑布</>就非常可疑了！\n\r\n半兽人竟然就这样从那后面消失了……得亲自去探个究竟才行。
    --23EC316DF60   0000C3B4 - 0000C3B9   005  false    00049480 - 【奇缘】血斗士洞穴  46.0 - 3884.4 - 888.7   半兽人角笛                  血光半兽人角
    --23EC316E080   0000C3B4 - 0000C3BA   006  true     00049480 - 【奇缘】血斗士洞穴  40.0 - -690.0 - 128.0   半兽人角笛                  血光半兽人角   瀑布后面竟然还有这样的空间！\r\n\r\n眼前的<span color="#5B93B4FF">石碑</>上……\r\n写着什么？\r\n过去仔细瞧瞧吧。\r\n说不定是很重要的内容呢。
    --23EC316E1A0   0000C3B4 - 0000C3BB   007  false    00049480 - 【奇缘】血斗士洞穴  36.0 - -682.0 - 58.0   半兽人角笛                  血光半兽人角   好！管它是血光血斗士还是什么，我都帮你搞定。\r\n咦，等等？\r\n这，该不会……是半兽人族长的决斗吧？\r\n这样的话我？哈哈哈\r\n诶咦，应该不会吧！\r\n\r\n先往死里打了再说。
