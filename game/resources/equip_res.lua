...
local equip_res = {
    EQUIP_INFO = {
        ['武器'] = { pos = 1, [1] = '角弓', [2] = '龙角弓', [3] = '迷离弓',[4] = '月光弩' },
        ['副手'] = { pos = 9, [1] = '箭筒', [2] = '金刚木箭筒', [3] = '迷离箭筒', [4] = '月光箭筒' },

        ['上衣'] = { pos = 5, [1] = '丝绸衣上衣', [2] = '密影衣上衣', [3] = '鬼灵巫服上衣', [4] = '镇魂巫服上衣' },
        ['下装'] = { pos = 6, [1] = '丝绸衣下衣', [2] = '密影衣下衣', [3] = '鬼灵巫服下衣', [4] = '镇魂巫服下衣' },

        ['手套'] = { pos = 7, [1] = '丝绸衣手套', [2] = '密影衣手套', [3] = '鬼灵巫服手套', [4] = '镇魂巫服手套' },
        ['鞋子'] = { pos = 8, [1] = '丝绸衣鞋靴', [2] = '密影衣鞋靴', [3] = '鬼灵巫服鞋靴', [4] = '镇魂巫服鞋靴' },

        ['项链'] = { pos = 2, [1] = '无我项链', [2] = '神灵项链', [3] = '猛攻项链', [4] = '月光项链' },
        ['手环'] = { pos = 3, [1] = '无我手环', [2] = '神灵手环', [3] = '猛攻手环', [4] = '月光手环' },

        ['指环'] = { pos = 4, [1] = '无我指环', [2] = '神灵指环', [3] = '猛攻指环', [4] = '月光指环' },
        ['耳环'] = { pos = 10, [1] = '无我耳环', [2] = '神灵耳环', [3] = '猛攻耳环', [4] = '月光耳环' },
    ...
    BUILD_EQUIP_LIST = {
        ...
        ['迷离弓'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有邪念珠', num = 25 }, stuff3 = { name = '稀有月阴石', num = 25 }, stuff4 = { name = '稀有龙鳞', num = 1 }, money = 50000, heitie = 10000, make_id = 0xDBBA0A, make_type = 2,qinglong_make_id = 0xD903E0 },
        ...
        ['角弓'] = { stuff1 = { name = '高级钢铁', num = 40 }, stuff2 = { name = '高级邪念珠', num = 4 }, stuff3 = { name = '高级月阴石', num = 1 }, stuff4 = { name = '高级龙鳞', num = 1 }, money = 1000, heitie = 1000, make_id = 0xD72621, make_type = 1, not_sys_id = true },

        -- 箭筒
        ['箭筒'] = { stuff1 = { name = '高级钢铁', num = 40 }, stuff2 = { name = '高级邪念珠', num = 4 }, stuff3 = { name = '高级月阴石', num = 1 }, stuff4 = { name = '高级龙爪', num = 1 }, money = 1000, heitie = 1000, make_id = 0x00D72A09, make_type = 1, not_sys_id = true },
        ...
        ['迷离箭筒'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有邪念珠', num = 25 }, stuff3 = { name = '稀有月阴石', num = 25 }, stuff4 = { name = '稀有龙爪', num = 1 }, money = 50000, heitie = 50000, make_id = 0x00DBBDF1, make_type = 2,qinglong_make_id = 0 },
        ...
        ['鬼灵巫服上衣'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有武魂', num = 4 }, stuff3 = { name = '稀有伏魔神珠', num = 1 }, stuff4 = { name = '稀有龙皮', num = 1 }, money = 25000, heitie = 5000, make_id = 0X017450A8, make_type = 2,qinglong_make_id = 0x00D903E4 },
        ...
        ['鬼灵巫服下衣'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有武魂', num = 4 }, stuff3 = { name = '稀有伏魔神珠', num = 1 }, stuff4 = { name = '稀有龙皮', num = 1 }, money = 25000, heitie = 5000, make_id = 0x017450C6, make_type = 2,qinglong_make_id = 0x00D903E8 },
        ...
        ['鬼灵巫服手套'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有武魂', num = 4 }, stuff3 = { name = '稀有伏魔神珠', num = 1 }, stuff4 = { name = '稀有龙皮', num = 1 }, money = 25000, heitie = 5000, make_id = 0x020CE764, make_type = 2,qinglong_make_id = 0x00D903EC },
        ...
        ['鬼灵巫服鞋靴'] = { stuff1 = { name = '稀有钢铁', num = 75 }, stuff2 = { name = '稀有武魂', num = 4 }, stuff3 = { name = '稀有伏魔神珠', num = 1 }, stuff4 = { name = '稀有龙皮', num = 1 }, money = 25000, heitie = 5000, make_id = 0x020CE782, make_type = 2,qinglong_make_id = 0x00D903F0 },
        ...
        ['猛攻项链'] = { stuff1 = { name = '稀有白金', num = 75 }, stuff2 = { name = '稀有矿片', num = 25 }, stuff3 = { name = '稀有灵石', num = 25 }, stuff4 = { name = '稀有龙角', num = 1 }, money = 50000, heitie = 10000, make_id = 0x0268748A, make_type = 2,qinglong_make_id = 0x009BFBA8 },
        ...
        ['猛攻手环'] = { stuff1 = { name = '稀有白金', num = 75 }, stuff2 = { name = '稀有矿片', num = 25 }, stuff3 = { name = '稀有灵石', num = 25 }, stuff4 = { name = '稀有龙角', num = 1 }, money = 50000, heitie = 10000, make_id = 0x026874A8, make_type = 2,qinglong_make_id = 0x009BFBAC },
        ...
        ['猛攻指环'] = { stuff1 = { name = '稀有白金', num = 75 }, stuff2 = { name = '稀有矿片', num = 25 }, stuff3 = { name = '稀有灵石', num = 25 }, stuff4 = { name = '稀有龙角', num = 1 }, money = 50000, heitie = 10000, make_id = 0x03010B46, make_type = 2,qinglong_make_id = 0x009BFBB0 },
        ...
        ['猛攻耳环'] = { stuff1 = { name = '稀有白金', num = 75 }, stuff2 = { name = '稀有矿片', num = 25 }, stuff3 = { name = '稀有灵石', num = 25 }, stuff4 = { name = '稀有龙眼', num = 1 }, money = 50000, heitie = 50000, make_id = 0x03010EF1, make_type = 2,qinglong_make_id = 0 },
